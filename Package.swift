...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/getstoryteller/storyteller-sdk-swift-package", exact: "10.8.2")
    ],
    targets: [
        .binaryTarget(name: "StorytellerGAMIntegration",
                      url: "https://storyteller.azureedge.net/sdk-ios/xcframeworks/10.8.2/StorytellerGAMIntegration.zip",
                      checksum: "8a730fe60a827a56ab25dbccfc0145c39ae716cd3d8913151f328530d2e16e4e"),
        .target(
