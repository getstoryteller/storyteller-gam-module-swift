...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/getstoryteller/storyteller-sdk-swift-package", exact: "10.8.0")
    ],
    targets: [
        .binaryTarget(name: "StorytellerGAMIntegration",
                      url: "https://storyteller.azureedge.net/sdk-ios/xcframeworks/10.8.0/StorytellerGAMIntegration.zip",
                      checksum: "0f34abd56fe4a5fd87c6cc7fc3d6167c7099c928247ebf4dcb92cce20a13751c"),
        .target(
