...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/getstoryteller/storyteller-sdk-swift-package", exact: "10.12.0")
    ],
    targets: [
        .binaryTarget(name: "StorytellerGAMIntegration",
                      url: "https://storyteller.azureedge.net/sdk-ios/xcframeworks/10.12.0/StorytellerGAMIntegration.zip",
                      checksum: "028020561c1d7cb57fe6860e2e3ae0d505fe3da9ca83f910a75816db94038f28"),
        .target(
