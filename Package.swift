...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/getstoryteller/storyteller-sdk-swift-package", exact: "11.0.0-alpha.5")
    ],
    targets: [
        .binaryTarget(name: "StorytellerGAMIntegration",
                      url: "https://storyteller.azureedge.net/sdk-ios/xcframeworks/11.0.0-alpha.5/StorytellerGAMIntegration.zip",
                      checksum: "42d9f6cef528973219a9b71add21a97b50fb0de2acd45c3b2cc69bbc9fe27681"),
        .target(
