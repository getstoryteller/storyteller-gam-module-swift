...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/getstoryteller/storyteller-sdk-swift-package", exact: "11.0.0-alpha.2")
    ],
    targets: [
        .binaryTarget(name: "StorytellerGAMIntegration",
                      url: "https://storyteller.azureedge.net/sdk-ios/xcframeworks/11.0.0-alpha.2/StorytellerGAMIntegration.zip",
                      checksum: "7299928f7f0fe89ce53c87b6b9dc2cc42330b72ed4eca6d9dbc2e1525bb049ad"),
        .target(
