...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/getstoryteller/storyteller-sdk-swift-package", exact: "10.5.2")
    ],
    targets: [
        .binaryTarget(name: "StorytellerGAMIntegration",
                      url: "https://storyteller.azureedge.net/sdk-ios/xcframeworks/10.5.2/StorytellerGAMIntegration.zip",
                      checksum: "db2155ce02b46cfc17bdffd40b05d6ca0545d103331525ca794f9842d81dde20"),
        .target(
