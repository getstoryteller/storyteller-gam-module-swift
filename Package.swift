...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/getstoryteller/storyteller-sdk-swift-package", exact: "10.7.7")
    ],
    targets: [
        .binaryTarget(name: "StorytellerGAMIntegration",
                      url: "https://storyteller.azureedge.net/sdk-ios/xcframeworks/10.7.7/StorytellerGAMIntegration.zip",
                      checksum: "fa6924a1d40caefbe66323b31c4c657d34739fcca0d1e22378de5e6151b1bbde"),
        .target(
